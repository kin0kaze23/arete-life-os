...
import {
  buildGuidanceTelegramMessage,
  canSendGuidanceMessage,
} from './_guidance.js';
import {
...
const handleProactiveGuidance = async (req: VercelRequest, res: VercelResponse) => {
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  if (req.method === 'GET') {
    return await handleProactiveGuidance(req, res);
  }
