...
export class AlibabaProvider implements AIProvider {
  ...
  supportsSearch = true; // Assuming Qwen models can support search if configured
  ...
  async generateJSON<T>(
    ...
    try {
      ...
      console.error('Error parsing JSON response from Alibaba API:', e);
      console.log('Raw response:', responseText);
      throw new Error(`Failed to parse JSON response from Alibaba API: ${(e as Error).message}`);
    }
  }
