              ...
              {habitItems.length > 0 ? (
                <div className="flex flex-wrap gap-2">
                  {habitItems.map((habit) => (
                    <span
                      key={habit.id}
                      className="px-3 py-2 rounded-full bg-violet-500/10 text-[9px] font-black uppercase tracking-widest text-violet-300 border border-violet-500/20"
                    >
                      {habit.title}
