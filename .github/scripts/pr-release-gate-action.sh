...
if [[ "$REVIEWER_REQUIRED" == "true" ]]; then
  ...
  REVIEWER_EVIDENCE_OUTPUT=$(bash "$ROOT_DIR/.github/scripts/reviewer-evidence-detector.sh" --pr "$PR_NUMBER" 2>/dev/null || echo "")
...
---
*Generated by v4.35 PR Release Gate with Reviewer Evidence Enforcement. See [docs/PR_RELEASE_GATE.md](docs/PR_RELEASE_GATE.md) for how to read this summary.*
EOF
