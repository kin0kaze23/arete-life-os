---
name: prompt-flow-optimization
description: Optimizes AI processing flows, model assignments, and token usage to reduce cost without degrading quality. Use when modifying AI extraction or generation logic.
---
