---
name: Debugging 500 Errors in Vite Dev Server
description: Systematic approach to debugging 500 Internal Server Errors in the Vite dev environment, with emphasis on proper error logging and isolation
---
