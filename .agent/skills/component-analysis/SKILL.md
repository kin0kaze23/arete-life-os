...
description: Analyzes React components for architecture, state management, props, and design system compliance. Use when reviewing or creating new UI components.
---
